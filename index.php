...
$acc_username = "JetFrancis";
$acc_password = "jetfrancis123";
$acc_fullname = "Jet Francis Podaca";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist'])===true){
		      						...
		      						echo "<div class='alert alert-success' role='alert'> Redirecting, please wait... </div>";
		      						header("Refresh: 5; url=account.php");
		      			
		      			}else if (isset($_REQUEST['logout'])===true){
		      						echo "<div class='alert alert-info' role='alert'> Previous account have been signed out. </div>";

		      			}else if(isset($_REQUEST['logfirst'])===true){
		      						echo "<div class='alert alert-warning' role='alert'> Logging-in is necessary. </div>";
